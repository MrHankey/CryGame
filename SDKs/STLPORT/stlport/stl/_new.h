...
#    endif
#		 if defined(SPU) || defined(__SPU__) // PS3_STLPORT_FIX: Don't use puts for SPUs, it breaks scanning
...
#if defined(PS3)
inline void* _STLP_CALL __stl_new(size_t __n, size_t alignment)   { _STLP_CHECK_NULL_ALLOC(::operator new(__n, alignment)); }
#endif
