...
public:
  logic_error(const char* __s) : __Named_exception(__s) {}
...
public:
  runtime_error(const char* __s) : __Named_exception(__s) {}
#    ifndef _STLP_USE_NO_IOSTREAMS
...
public:
  domain_error(const char* __arg) : logic_error(__arg) {}
#    ifndef _STLP_USE_NO_IOSTREAMS
...
public:
  invalid_argument(const char* __arg) : logic_error(__arg) {}
#    ifndef _STLP_USE_NO_IOSTREAMS
...
public:
  length_error(const char* __arg) : logic_error(__arg) {}
#    ifndef _STLP_USE_NO_IOSTREAMS
...
public:
  out_of_range(const char* __arg) : logic_error(__arg) {}
#    ifndef _STLP_USE_NO_IOSTREAMS
...
public:
  range_error(const char* __arg) : runtime_error(__arg) {}
#    ifndef _STLP_USE_NO_IOSTREAMS
...
public:
  overflow_error(const char* __arg) : runtime_error(__arg) {}
#    ifndef _STLP_USE_NO_IOSTREAMS
...
public:
  underflow_error(const char* __arg) : runtime_error(__arg) {}
#    ifndef _STLP_USE_NO_IOSTREAMS
