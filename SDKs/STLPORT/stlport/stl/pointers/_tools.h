...
struct _VoidCastTraitsAux {
  ...
  static ILINE void_type * uncv_ptr(void_cv_type *__ptr)
  { return __ptr; }
  static ILINE void_type const* uncv_cptr(void_cv_type const*__ptr)
  { return __ptr; }
  static ILINE void_type ** uncv_pptr(void_cv_type **__ptr)
  { return __ptr; }
  static ILINE void_type & uncv_ref(void_cv_type & __ref)
  { return __ref; }
  static ILINE void_type const& uncv_cref(void_cv_type const& __ref)
  { return __ref; }
  static ILINE void_cv_type* cv_ptr(void_type *__ptr)
  { return __ptr; }
  static ILINE void_cv_type const* cv_cptr(void_type const*__ptr)
  { return __ptr; }
  static ILINE void_cv_type ** cv_pptr(void_type **__ptr)
  { return __ptr; }
  static ILINE void_cv_type & cv_ref(void_type & __ref)
  { return __ref; }
  static ILINE void_cv_type const& cv_cref(void_type const& __ref)
  { return __ref; }
};
...
struct _VoidCastTraitsAuxBase {
  ...
  static ILINE void_type const& uncv_cref(void_cv_type const& __ptr)
  { return __CONST_CAST(void_type const&, __ptr); }
...
struct _CastTraits {
  ...
  static ILINE value_type * to_value_type_ptr(void_type *__ptr)
  { return __REINTERPRET_CAST(value_type *, cv_traits::cv_ptr(__ptr)); }
  static ILINE value_type const* to_value_type_cptr(void_type const*__ptr)
  { return __REINTERPRET_CAST(value_type const*, cv_traits::cv_cptr(__ptr)); }
  static ILINE value_type ** to_value_type_pptr(void_type **__ptr)
  { return __REINTERPRET_CAST(value_type **, cv_traits::cv_pptr(__ptr)); }
  static ILINE value_type & to_value_type_ref(void_type &__ref)
  { return __REINTERPRET_CAST(value_type &, cv_traits::cv_ref(__ref)); }
  static ILINE value_type const& to_value_type_cref(void_type const& __ptr)
  { return __REINTERPRET_CAST(value_type const&, cv_traits::cv_cref(__ptr)); }
  // Reverse versions
  static ILINE void_type * to_storage_type_ptr(value_type *__ptr)
  { return cv_traits::uncv_ptr(__REINTERPRET_CAST(void_cv_type *, __ptr)); }
  static ILINE void_type const* to_storage_type_cptr(value_type const*__ptr)
  { return cv_traits::uncv_cptr(__REINTERPRET_CAST(void_cv_type const*, __ptr)); }
  static ILINE void_type ** to_storage_type_pptr(value_type **__ptr)
  { return cv_traits::uncv_pptr(__REINTERPRET_CAST(void_cv_type **, __ptr)); }
  static ILINE void_type const& to_storage_type_cref(value_type const& __ref)
  ...
  static ILINE void_type const& to_storage_type_crefT(value_type const& __ref)
...
struct _CastTraits<_Tp, _Tp> {
  ...
  static ILINE value_type * to_value_type_ptr(storage_type *__ptr)
  { return __ptr; }
  static ILINE value_type const* to_value_type_cptr(storage_type const*__ptr)
  { return __ptr; }
  static ILINE value_type ** to_value_type_pptr(storage_type **__ptr)
  { return __ptr; }
  static ILINE value_type & to_value_type_ref(storage_type &__ref)
  { return __ref; }
  static ILINE value_type const& to_value_type_cref(storage_type const&__ref)
  { return __ref; }
  // Reverse versions
  static ILINE storage_type * to_storage_type_ptr(value_type *__ptr)
  { return __ptr; }
  static ILINE storage_type const* to_storage_type_cptr(value_type const*__ptr)
  { return __ptr; }
  static ILINE storage_type ** to_storage_type_pptr(value_type **__ptr)
  { return __ptr; }
  static ILINE storage_type const& to_storage_type_cref(value_type const& __ref)
  { return __ref; }

  //Method used to treat set container template method extension
  template <class _Tp1>
  static ILINE _Tp1 const& to_storage_type_crefT(_Tp1 const& __ref)
  { return __ref; }
};
...
struct _IteWrapper {
  ...
  ILINE _Self& operator= (_Self const& __rhs) {
    _M_ite = __rhs._M_ite;
    return *this;
  }

  ILINE _Self& operator++() {
    ++_M_ite;
    return *this;
  }
  ...
  ILINE _Self& operator += (difference_type __offset) {
    _M_ite += __offset;
    return *this;
  }
  
  ILINE difference_type operator -(_Self const& __other) const
  { return _M_ite - __other._M_ite; }

  ILINE bool operator == (_Self const& __other) const
  { return _M_ite == __other._M_ite; }

  ILINE bool operator != (_Self const& __other) const
  { return _M_ite != __other._M_ite; }

  ILINE bool operator < (_Self const& __rhs) const
