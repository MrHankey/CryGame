...
#  if defined (_MIPSEB) || defined (__sparc) || defined (_AIX) || \
      defined (__hpux) || defined (macintosh) || defined (_MAC) || defined(PS3)  || defined(_XBOX_VER)// PS3_STLPORT_FIX: PS3 is BIG_ENDIAN
...
#if !defined (_STLP_NO_AT_MEMBER_FUNCTION) && !defined(PS3) // PS3_STLPORT_FIX
...
#  if defined (_STLP_NO_USING_FOR_GLOBAL_FUNCTIONS) && !defined (_STLP_DO_IMPORT_CSTD_FUNCTIONS) || defined(PS3) // PS3_STLPORT_FIX
