...
// PS3_STLPORT_FIX: Added PS3 to the following define
#if (defined (__OpenBSD__) || defined (__FreeBSD__) || defined (__hpux) || defined(PS3)) && defined (__GNUC__) && !defined (_GLIBCPP_HAVE_MBSTATE_T)
